...
//  private _chaturl = "http://172.23.239.243:7001/chat-api/chat/workspaces"; // api gateway

private _chaturl = "http://13.233.42.222/chat-api/api/chat/workspaces"; // aws

//  private _ipaddress = "http://172.23.238.165:7000";
  // private inviteusers: string = "http://172.23.239.243:7001/onboard-api/invite";
  ...
  getUserById(userid:string):Observable<User>{
    ...
    // const url = "http://172.23.239.243:5004/chat-api/chat/user"
  ...
  getAllUsersInWorkspace(workspaceName:string):Observable<User[]>{
    ...
    // const url = "http://172.23.239.243:7001/chat-api/chat/workspaces/user";
