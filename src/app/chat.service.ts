...
//  private _chaturl = "http://172.23.239.243:7001/connect/api/chat/workspaces"; // api gateway

private _chaturl = "http://13.233.42.222/connect/api/chat/workspaces"; // aws

//  private _ipaddress = "http://172.23.238.165:7000";
  // private inviteusers: string = "http://172.23.239.243:7001/onboard/invite";
  ...
  getUserById(userid:string):Observable<User>{
    ...
    // const url = "http://172.23.239.243:5004/api/chat/user"
    const url = "http://13.233.42.222/connect/api/chat/user" //aws
  ...
  getAllUsersInWorkspace(workspaceName:string):Observable<User[]>{
    ...
    // const url = "http://172.23.239.243:7001/connect/api/chat/workspaces/user";
    const url = "http://13.233.42.222/connect/api/chat/workspaces/user"; // aws
